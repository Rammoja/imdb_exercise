...
star1 = Star.new({'first_name' => 'Harrison', 'second_name' => 'Ford'})
star1.save()
star2 = Star.new({ 'first_name' => 'Carrie', 'second_name' => 'Fisher'})
star2.save()
star3 = Star.new({'first_name' => 'Liam', 'second_name' => 'Neeson'})
star3.save()
